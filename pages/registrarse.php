            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 form-box">
                    	<form role="form" action="ejecutarRegistro.php" method="post" class="f1">
                    		...
                    		<fieldset>
                    			...
                    			<div class="form-group">
                                    ...
                                    <input type="text" name="nombrePersona" placeholder="Nombre..." class="f1-first-name form-control" id="f1-first-name">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="f1-last-name">Apellido</label>
                                    <input type="text" name="apellidoPersona" placeholder="Apellido..." class="f1-last-name form-control" id="f1-last-name">
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombreUsuario" placeholder="Usuario..." class="f1-email form-control" id="f1-email">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="f1-email">Usuario</label>
                                    <input type="text" name="correo" placeholder="Correo..." class="f1-email form-control" id="f1-email">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="repetirPassword" placeholder="Repetir password..." 
